     ...
     if (message.content.includes(`afk`)) return;
      ...
      if(etiket){
        ...
        let timeObj = ms(Date.now() - time);
          message.channel.send(betaafk.setDescription(`${etiket} adlı kullanıcı **${reason}** sebebiyle \`${timeObj}\` süresi boyunca afk.`).setColor("#2F3136"))}}
